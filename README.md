...
2. Expose a REST API that enables users to query this database for flight data at certain geographical locations using certain parameters such as radius (distance) and altitude
